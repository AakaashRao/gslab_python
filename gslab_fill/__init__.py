'''
gslab_fill: A library for filling LyX templates with tablular data and Stata output
===================================================================================

gslab_fill provides two functions for filling LyX template files with data. 
